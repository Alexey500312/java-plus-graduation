...
public class EventServiceImpl implements EventService {
    ...
    public EventDto createEvent(Long userId, CreateEventDto createEventDto) {
        ...
        return EventMapper.INSTANCE.toEventDto(eventRepository.save(event), statsClient);
    }
    ...
    public Collection<EventDto> getEvents(Long userId, int from, int size) {
        ...
        return EventMapper.INSTANCE.toEventDtoCollection(eventRepository.findAll(predicate, pageOffset).getContent(), statsClient);
    }
    ...
    public Collection<EventDto> getEvents(EventSearch search) {
        return EventMapper.INSTANCE.toEventDtoCollection(getEventsInternal(search), statsClient);
    }
    ...
    public Collection<EventShortDto> getPublishedEvents(EventSearch search) {
        return EventMapper.INSTANCE.toEventShortDtoCollection(getEventsInternal(search), statsClient);
    }
    ...
    public EventDto getEventById(Long userId, Long eventId) {
        ...
        return EventMapper.INSTANCE.toEventDto(event, statsClient);
    }
