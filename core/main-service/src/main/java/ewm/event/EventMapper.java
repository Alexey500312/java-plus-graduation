...
public interface EventMapper {
    ...
    EventDto toEventDto(Event event, @Context StatsClient statsClient);
     ...
     */
    @Mapping(target = "views", source = "id", qualifiedByName = "getEventViews")
    EventShortDto toEventShortDto(Event event, @Context StatsClient statsClient);
     ...
     */
    Collection<EventDto> toEventDtoCollection(Collection<Event> events, @Context StatsClient statsClient);
     ...
     */
    Collection<EventShortDto> toEventShortDtoCollection(Collection<Event> events, @Context StatsClient statsClient);

    @Named("getEventViews")
    static int getEventViews(Long eventId, @Context StatsClient statsClient) {
