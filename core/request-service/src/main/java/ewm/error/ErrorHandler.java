...
public class ErrorHandler {
    ...
    public ResponseEntity<ApiError> handleFeign(FeignException e) throws Exception {
        return new ResponseEntity<>(mapper.readValue(e.contentUTF8(), ApiError.class), HttpStatus.valueOf(e.status()));
    }
