...
public interface EventService {
    ...
    EventFeignDto findEventById(Long eventId);

    Collection<EventFeignDto> findEventCollection(Collection<Long> eventIds);

    void changeConfirmedRequests(Long eventId, Integer confirmedRequests);
