...
import ewm.EventServiceApplication;
...
class AdminCategoryControllerTest {
    ...
    public void should_ThrowHttpMessageNotReadableExceptionAndReturnBadRequest_WhenCreateCategoryRequestMadeWithoutBody() {
        mockMvc.perform(post("/admin/categories"))
                ...
                .andExpect(result -> {
                    ...
                    assertEquals("Required request body is missing: public ru.practicum.dto.category.CategoryDto ewm.category.AdminCategoryController.createCategory(ru.practicum.dto.category.CreateCategoryDto)", result.getResolvedException().getMessage());
                })
    ...
    public void should_ThrowHttpMessageNotReadableExceptionAndReturnBadRequest_WhenUpdateCategoryRequestMadeWithNegativeCategoryId() {
        mockMvc.perform(patch("/admin/categories/-1"))
                ...
                .andExpect(result -> {
                    assertInstanceOf(HttpMessageNotReadableException.class, result.getResolvedException());
                    assertEquals("Required request body is missing: public ru.practicum.dto.category.CategoryDto ewm.category.AdminCategoryController.updateCategory(java.lang.Long,ru.practicum.dto.category.UpdateCategoryDto)", result.getResolvedException().getMessage());
                })
                .andExpect(jsonPath("$.status", is(HttpStatus.BAD_REQUEST.name())))
                .andExpect(jsonPath("$.reason", is("Incorrectly made request.")))
                .andExpect(jsonPath("$.message", is("Error request body")))
