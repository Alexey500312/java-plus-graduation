...
import ewm.UserServiceApplication;
    ...
    public void should_ThrowHttpMessageNotReadableExceptionAndReturnBadRequest_WhenBodyIsNull() {
        mockMvc.perform(post("/admin/users"))
                ...
                .andExpect(result -> {
                    ...
                    assertEquals("Required request body is missing: public ru.practicum.dto.user.UserDto ewm.user.AdminUserController.createUser(ru.practicum.dto.user.CreateUserDto)", result.getResolvedException().getMessage());
                })
